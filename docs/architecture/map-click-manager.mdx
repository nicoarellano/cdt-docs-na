...
Source: `@collabdt/core/components/viewers/map/utils/MapEventManager/MapClickManager.ts`
...
| File | Role |
|------|------|
| `@collabdt/core/components/viewers/map/utils/MapEventManager/MapClickManager.ts` | Full implementation |
| `@collabdt/core/components/viewers/map/src/MapLayers/src/BuildingLayers/index.tsx` | Example of register/unregister pattern |
