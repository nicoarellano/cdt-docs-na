...
description: Choose how to run the CDT platform — self-hosted on your own infrastructure or managed by the CDT team.
sidebar_position: 1
---
...
[Read the Self-Hosting guide →](./self-hosting.md)
...
[Read about CDT Hosted →](./cdt-hosted.md)
