...
Open `http://localhost:3000`. You should see the CDT sign-in screen. Create an account, then complete the [Quickstart](./quickstart.mdx) to confirm the full stack works end-to-end.
