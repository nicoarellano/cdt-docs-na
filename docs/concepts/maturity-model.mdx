...
- **Data Governance & Sovereignty** — clear ownership, access control, and sovereign-hosted storage so the data stays where it should — stewarded by [Collab Digital Twins](https://collabdt.org), a not-for-profit, in the public interest.
