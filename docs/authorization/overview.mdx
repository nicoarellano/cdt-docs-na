...
CDT uses **role-based access control** scoped to **organizations**. This page explains the model in plain language. For step-by-step UI tasks, see [Managing roles and permissions](./managing-roles.mdx). For the engine internals, see [Roles, Permissions & CASL](./authorization_roles_permissions.md).
...
| You want to… | Read |
|--------------|------|
| Invite members and assign them a role | [Managing roles and permissions](./managing-roles.mdx) |
